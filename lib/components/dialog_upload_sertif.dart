...
class DialogUploadSertif extends StatefulWidget {
  final List<dynamic> refJenisKursus;
  final Function(bool status) isUploading;
  const DialogUploadSertif(
      {super.key, required this.refJenisKursus, required this.isUploading});

  @override
  State<DialogUploadSertif> createState() => _DialogUploadSertifState();
}

class _DialogUploadSertifState extends State<DialogUploadSertif> {
  File? fileResult;
